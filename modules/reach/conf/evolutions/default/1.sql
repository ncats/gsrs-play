...
alter table ix_core_structure add constraint fk_ix_core_structure_namespace_26 foreign key (namespace_id) references ix_core_namespace (id) on delete restrict on update restrict;
create index ix_ix_core_structure_namespace_26 on ix_core_structure (namespace_id);
alter table ix_core_xref add constraint fk_ix_core_xref_namespace_27 foreign key (namespace_id) references ix_core_namespace (id) on delete restrict on update restrict;
create index ix_ix_core_xref_namespace_27 on ix_core_xref (namespace_id);
