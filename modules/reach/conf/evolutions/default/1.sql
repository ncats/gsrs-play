...
alter table ix_core_structure add constraint fk_ix_core_structure_namespac_26 foreign key (namespace_id) references ix_core_namespace (id) on delete restrict on update restrict;
create index ix_ix_core_structure_namespac_26 on ix_core_structure (namespace_id);
