...
public class ReachApp extends Controller {
    ...
    public static Result error (int code, String mesg) {
        return ok (ix.publications.views.html.error.render(code, mesg));
    }
    ...
    public static Result publication (long id) {
        try {
            ...
            return internalServerError
                (ix.publications.views.html.error.render(500, "Internal server error"));
        }
    }
    ...
    public static Result publications (final String q, int rows, final int page) {
        ...
        try {
            ...
            ex.printStackTrace();
            return badRequest (ix.publications.views.html.error.render
    ...
    public static Result search (int rows) {
        ...
        return internalServerError (ix.publications.views.html.error.render
