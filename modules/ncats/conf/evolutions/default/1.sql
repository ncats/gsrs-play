...
alter table ix_core_structure add constraint fk_ix_core_structure_namespac_27 foreign key (namespace_id) references ix_core_namespace (id) on delete restrict on update restrict;
create index ix_ix_core_structure_namespac_27 on ix_core_structure (namespace_id);
alter table ix_core_userprof add constraint fk_ix_core_userprof_namespace_28 foreign key (namespace_id) references ix_core_namespace (id) on delete restrict on update restrict;
create index ix_ix_core_userprof_namespace_28 on ix_core_userprof (namespace_id);
alter table ix_core_userprof add constraint fk_ix_core_userprof_user_29 foreign key (user_id) references ix_core_principal (id) on delete restrict on update restrict;
create index ix_ix_core_userprof_user_29 on ix_core_userprof (user_id);
alter table ix_core_xref add constraint fk_ix_core_xref_namespace_30 foreign key (namespace_id) references ix_core_namespace (id) on delete restrict on update restrict;
create index ix_ix_core_xref_namespace_30 on ix_core_xref (namespace_id);
