...
(function(){
	...
	var delim = data.delim || '.';
	var click = data.click;

	if (!url && !json) {
	    throw "Neither url nor json is specified!";
	}
	...
	function getColor (str) {
	   ...
	   */
	   ...
	   for (var i = 0; i < sequenceArray.length; ++i) {
	       console.log(i+': '+sequenceArray[i].name);
	   }
	   */
	   ...
	   d3.select('#'+id+'-tip')
	       .html("<span class='label label-default'>"
		     +sequenceArray[sequenceArray.length-1].name
		     +"</span>");
       }
	   ...
	   var legend = d3.select("#legend").append("svg:svg")
	       .attr("width", li.w)
	       .attr("height", colors.length * (li.h + li.s));
