        ...
        HANDLERS.put("viewTargets",
                new AbstractDynamicResourceHandler() {
                    public boolean isAllowed(final String name,
                        ...
                        boolean allowed;
                        if (new DeadboltAnalyzer().hasRole(subject, "User")) {
                            allowed = true;
                        } else {
        ...
        HANDLERS.put("viewDetails",
                new AbstractDynamicResourceHandler() {
                    public boolean isAllowed(final String name,
                        ...
                        if (analyzer.hasRole(subject, "Admin") && analyzer.checkPatternEquality(subject, "ReadWrite")) {
                            allowed = true;
                        } else {
                            // a call to view profile is probably a get request, so
                            // the query string is used to provide info
