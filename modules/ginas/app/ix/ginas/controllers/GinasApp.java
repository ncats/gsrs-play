...
return F.Promise.<Result>promise( () -> {
    ...
    public static void sillyTest(){
    	EntityUtils.getEntityInfoFor(ix.test.models.view.TestModel.class)
    		    .getFinder()
		    	.all()
		    	.stream()
		    	.forEach(t->{
    	...
    	try{
    		new ProcessExecutionService(5,10).process(CommonStreamSuppliers.allForDeep(ix.test.models.view.TestModel.class), CommonConsumers.REINDEX_COMPLETE, ProcessListener.doNothingListener());



    		SearchRequest request = new SearchRequest.Builder()
    				.top(16)
    				.kind(ix.test.models.view.TestModel.class)
    				.fdim(FACET_DIM)
    				.query("Y4907O6MFD")
    				.build();
