...
alter table ix_core_role add constraint fk_ix_core_role_principal_23 foreign key (principal_id) references ix_core_principal (id) on delete restrict on update restrict;
create index ix_ix_core_role_principal_23 on ix_core_role (principal_id);
alter table ix_core_structure add constraint fk_ix_core_structure_namespac_24 foreign key (namespace_id) references ix_core_namespace (id) on delete restrict on update restrict;
create index ix_ix_core_structure_namespac_24 on ix_core_structure (namespace_id);
