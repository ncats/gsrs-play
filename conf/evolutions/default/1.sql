...
alter table ix_core_processingstatus add constraint fk_ix_core_processingstatus_payload_17 foreign key (payload_id) references ix_core_payload (id) on delete restrict on update restrict;
create index ix_ix_core_processingstatus_payload_17 on ix_core_processingstatus (payload_id);
...
alter table ix_core_publication add constraint fk_ix_core_publication_journal_20 foreign key (journal_id) references ix_core_journal (id) on delete restrict on update restrict;
create index ix_ix_core_publication_journal_20 on ix_core_publication (journal_id);
...
alter table ix_ginas_substance add constraint fk_ix_ginas_substance_structure_22 foreign key (structure_uuid) references ix_ginas_structure (uuid) on delete restrict on update restrict;
create index ix_ix_ginas_substance_structure_22 on ix_ginas_substance (structure_uuid);
