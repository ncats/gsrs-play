...
alter table ix_ncats_funding add constraint fk_ix_ncats_funding_ix_ncats_grant_9 foreign key (grant_id) references ix_ncats_grant (id) on delete restrict on update restrict;
create index ix_ix_ncats_funding_ix_ncats_grant_9 on ix_ncats_funding (grant_id);
...
alter table ix_core_investigator add constraint fk_ix_core_investigator_organization_11 foreign key (organization_id) references ix_core_organization (id) on delete restrict on update restrict;
create index ix_ix_core_investigator_organization_11 on ix_core_investigator (organization_id);
...
alter table ix_core_processingstatus add constraint fk_ix_core_processingstatus_payload_18 foreign key (payload_id) references ix_core_payload (id) on delete restrict on update restrict;
create index ix_ix_core_processingstatus_payload_18 on ix_core_processingstatus (payload_id);
...
alter table ix_core_publication add constraint fk_ix_core_publication_journal_21 foreign key (journal_id) references ix_core_journal (id) on delete restrict on update restrict;
create index ix_ix_core_publication_journal_21 on ix_core_publication (journal_id);
...
alter table ix_ginas_substance add constraint fk_ix_ginas_substance_structure_23 foreign key (structure_uuid) references ix_ginas_structure (uuid) on delete restrict on update restrict;
create index ix_ix_ginas_substance_structure_23 on ix_ginas_substance (structure_uuid);
...
alter table ix_ginas_citation_tag add constraint fk_ix_ginas_citation_tag_ix_ginas_citation_01 foreign key (ix_ginas_citation_uuid) references ix_ginas_citation (uuid) on delete restrict on update restrict;
...
alter table ix_idg_ligand_structure add constraint fk_ix_idg_ligand_structure_ix_idg_ligand_01 foreign key (ix_idg_ligand_id) references ix_idg_ligand (id) on delete restrict on update restrict;

alter table ix_idg_ligand_structure add constraint fk_ix_idg_ligand_structure_ix_ginas_structure_02 foreign key (ix_ginas_structure_uuid) references ix_ginas_structure (uuid) on delete restrict on update restrict;

alter table ix_ginas_name_domain add constraint fk_ix_ginas_name_domain_ix_ginas_name_01 foreign key (ix_ginas_name_uuid) references ix_ginas_name (uuid) on delete restrict on update restrict;
...
alter table ix_ginas_structure_hash add constraint fk_ix_ginas_structure_hash_ix_ginas_structure_01 foreign key (ix_ginas_structure_uuid) references ix_ginas_structure (uuid) on delete restrict on update restrict;
...
alter table ix_ginas_structure_fingerprint add constraint fk_ix_ginas_structure_fingerprint_ix_ginas_structure_01 foreign key (ix_ginas_structure_uuid) references ix_ginas_structure (uuid) on delete restrict on update restrict;
...
alter table ix_ginas_structure_citation add constraint fk_ix_ginas_structure_citation_ix_ginas_structure_01 foreign key (ix_ginas_structure_uuid) references ix_ginas_structure (uuid) on delete restrict on update restrict;

alter table ix_ginas_structure_citation add constraint fk_ix_ginas_structure_citation_ix_ginas_citation_02 foreign key (ix_ginas_citation_uuid) references ix_ginas_citation (uuid) on delete restrict on update restrict;
...
alter table ix_ginas_substance_citation add constraint fk_ix_ginas_substance_citation_ix_ginas_substance_01 foreign key (ix_ginas_substance_uuid) references ix_ginas_substance (uuid) on delete restrict on update restrict;

alter table ix_ginas_substance_citation add constraint fk_ix_ginas_substance_citation_ix_ginas_citation_02 foreign key (ix_ginas_citation_uuid) references ix_ginas_citation (uuid) on delete restrict on update restrict;

alter table ix_ginas_substance_moiety add constraint fk_ix_ginas_substance_moiety_ix_ginas_substance_01 foreign key (ix_ginas_substance_uuid) references ix_ginas_substance (uuid) on delete restrict on update restrict;

alter table ix_ginas_substance_moiety add constraint fk_ix_ginas_substance_moiety_ix_ginas_structure_02 foreign key (ix_ginas_structure_uuid) references ix_ginas_structure (uuid) on delete restrict on update restrict;

alter table ix_ginas_protein_subunit add constraint fk_ix_ginas_protein_subunit_ix_ginas_substance_01 foreign key (ix_ginas_substance_uuid) references ix_ginas_substance (uuid) on delete restrict on update restrict;
...
drop table ix_idg_ligand_structure;
