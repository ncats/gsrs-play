...
create table ix_ginas_structure (
  ...
  atropisomerism            tinyint(1) default 0,
...
alter table ix_core_predicate add constraint fk_ix_core_predicate_namespace_10 foreign key (namespace_id) references ix_core_namespace (id) on delete restrict on update restrict;
create index ix_ix_core_predicate_namespace_10 on ix_core_predicate (namespace_id);
...
alter table ix_core_processingstatus add constraint fk_ix_core_processingstatus_payload_13 foreign key (payload_id) references ix_core_payload (id) on delete restrict on update restrict;
create index ix_ix_core_processingstatus_payload_13 on ix_core_processingstatus (payload_id);
...
alter table ix_core_publication add constraint fk_ix_core_publication_journal_16 foreign key (journal_id) references ix_core_journal (id) on delete restrict on update restrict;
create index ix_ix_core_publication_journal_16 on ix_core_publication (journal_id);
...
alter table ix_ginas_substance add constraint fk_ix_ginas_substance_structure_18 foreign key (structure_id) references ix_ginas_structure (id) on delete restrict on update restrict;
create index ix_ix_ginas_substance_structure_18 on ix_ginas_substance (structure_id);
...
alter table ix_ginas_citation_tag add constraint fk_ix_ginas_citation_tag_ix_ginas_citation_01 foreign key (ix_ginas_citation_id) references ix_ginas_citation (id) on delete restrict on update restrict;

alter table ix_ginas_citation_tag add constraint fk_ix_ginas_citation_tag_ix_core_value_02 foreign key (ix_core_value_id) references ix_core_value (id) on delete restrict on update restrict;
...
alter table ix_idg_entity_synonym add constraint fk_ix_idg_entity_synonym_ix_idg_entity_01 foreign key (ix_idg_entity_synonym_id) references ix_idg_entity (id) on delete restrict on update restrict;
...
alter table ix_idg_entity_link add constraint fk_ix_idg_entity_link_ix_idg_entity_01 foreign key (ix_idg_entity_id) references ix_idg_entity (id) on delete restrict on update restrict;

alter table ix_idg_entity_link add constraint fk_ix_idg_entity_link_ix_core_xref_02 foreign key (ix_core_xref_id) references ix_core_xref (id) on delete restrict on update restrict;
...
alter table ix_idg_ligand add constraint fk_ix_idg_ligand_ix_idg_entity_01 foreign key (ix_idg_entity_id) references ix_idg_entity (id) on delete restrict on update restrict;

alter table ix_idg_ligand add constraint fk_ix_idg_ligand_ix_ginas_structure_02 foreign key (ix_ginas_structure_id) references ix_ginas_structure (id) on delete restrict on update restrict;
...
alter table ix_ginas_name_domain add constraint fk_ix_ginas_name_domain_ix_ginas_name_01 foreign key (ix_ginas_name_id) references ix_ginas_name (id) on delete restrict on update restrict;
...
alter table ix_ginas_structure_hash add constraint fk_ix_ginas_structure_hash_ix_ginas_structure_01 foreign key (ix_ginas_structure_id) references ix_ginas_structure (id) on delete restrict on update restrict;

alter table ix_ginas_structure_hash add constraint fk_ix_ginas_structure_hash_ix_core_value_02 foreign key (ix_core_value_id) references ix_core_value (id) on delete restrict on update restrict;

alter table ix_ginas_structure_fingerprint add constraint fk_ix_ginas_structure_fingerprint_ix_ginas_structure_01 foreign key (ix_ginas_structure_id) references ix_ginas_structure (id) on delete restrict on update restrict;

alter table ix_ginas_structure_fingerprint add constraint fk_ix_ginas_structure_fingerprint_ix_core_value_02 foreign key (ix_core_value_id) references ix_core_value (id) on delete restrict on update restrict;

alter table ix_ginas_structure_citation add constraint fk_ix_ginas_structure_citation_ix_ginas_structure_01 foreign key (ix_ginas_structure_id) references ix_ginas_structure (id) on delete restrict on update restrict;

alter table ix_ginas_structure_citation add constraint fk_ix_ginas_structure_citation_ix_ginas_citation_02 foreign key (ix_ginas_citation_id) references ix_ginas_citation (id) on delete restrict on update restrict;

alter table ix_ginas_substance_name add constraint fk_ix_ginas_substance_name_ix_ginas_substance_01 foreign key (ix_ginas_substance_id) references ix_ginas_substance (id) on delete restrict on update restrict;

alter table ix_ginas_substance_name add constraint fk_ix_ginas_substance_name_ix_ginas_name_02 foreign key (ix_ginas_name_id) references ix_ginas_name (id) on delete restrict on update restrict;

alter table ix_ginas_substance_code add constraint fk_ix_ginas_substance_code_ix_ginas_substance_01 foreign key (ix_ginas_substance_id) references ix_ginas_substance (id) on delete restrict on update restrict;

alter table ix_ginas_substance_code add constraint fk_ix_ginas_substance_code_ix_core_value_02 foreign key (ix_core_value_id) references ix_core_value (id) on delete restrict on update restrict;

alter table ix_ginas_substance_property add constraint fk_ix_ginas_substance_property_ix_ginas_substance_01 foreign key (ix_ginas_substance_id) references ix_ginas_substance (id) on delete restrict on update restrict;

alter table ix_ginas_substance_property add constraint fk_ix_ginas_substance_property_ix_core_value_02 foreign key (ix_core_value_id) references ix_core_value (id) on delete restrict on update restrict;

alter table ix_ginas_substance_citation add constraint fk_ix_ginas_substance_citation_ix_ginas_substance_01 foreign key (ix_ginas_substance_id) references ix_ginas_substance (id) on delete restrict on update restrict;

alter table ix_ginas_substance_citation add constraint fk_ix_ginas_substance_citation_ix_ginas_citation_02 foreign key (ix_ginas_citation_id) references ix_ginas_citation (id) on delete restrict on update restrict;

alter table ix_ginas_substance_moiety add constraint fk_ix_ginas_substance_moiety_ix_ginas_substance_01 foreign key (ix_ginas_substance_id) references ix_ginas_substance (id) on delete restrict on update restrict;

alter table ix_ginas_substance_moiety add constraint fk_ix_ginas_substance_moiety_ix_ginas_structure_02 foreign key (ix_ginas_structure_id) references ix_ginas_structure (id) on delete restrict on update restrict;

alter table ix_ginas_protein_subunit add constraint fk_ix_ginas_protein_subunit_ix_ginas_substance_01 foreign key (ix_ginas_substance_id) references ix_ginas_substance (id) on delete restrict on update restrict;

alter table ix_ginas_protein_subunit add constraint fk_ix_ginas_protein_subunit_ix_ginas_subunit_02 foreign key (ix_ginas_subunit_id) references ix_ginas_subunit (id) on delete restrict on update restrict;
...
drop table ix_ginas_citation;

drop table ix_ginas_citation_tag;
...
drop table ix_ginas_structure;

drop table ix_ginas_structure_hash;

drop table ix_ginas_structure_fingerprint;

drop table ix_ginas_structure_citation;
...
drop table ix_ginas_substance_citation;
