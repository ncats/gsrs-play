...
public class Grant extends Model {
    ...
    @Indexable(facet=true, name="Grant Activity")
    ...
    */
     ...
     */
    @Indexable(facet=true, name="Grant Admin IC")
     ...
     */
    @Indexable(facet=true, name="Grant Institution School")
     ...
     */
    @Indexable(facet=true, name="Grant Spending Category")
    ...
    @JoinTable(name="ix_ncats_grant_investigator")
    ...
    @JoinTable(name="ix_ncats_grant_keyword")
     ...
     */
    @Indexable(facet=true, name="Grant Study Section Code")
     ...
     */
    @Indexable(facet=true, name="Grant Study Section")
     ...
     */
    @Indexable(facet=true, name="Grant Suffix")
    public String suffix;

    /**
     */
    @Indexable(facet=true, name="Grant Funding Mechanism")
     ...
     */
    @ManyToMany(cascade=CascadeType.ALL)
    @JoinTable(name="ix_ncats_grant_publication")
